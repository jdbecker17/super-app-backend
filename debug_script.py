...
def test_logic():
    ...
    assets = [
        ...
        {"ticker": "BTC", "average_price": 40000.0, "category": "Cripto", "quantity": 0.1},
        {"ticker": "SELIC", "average_price": 1.0, "category": "Renda Fixa", "quantity": 100},
        {"ticker": "BAD_DATA", "average_price": None, "category": None, "quantity": 5} # Testing bad data
    ]
