...
def test_api():
    ...
    try:
        ...
        if res.status_code == 200: print("SUCCESS: Frontend loaded")
        else: print("FAIL: Frontend not 200")
    ...
    try:
        ...
        if res.status_code == 200:
            ...
            if found: print("VERIFIED: Newly added asset was found in list.")
            else: print("FAIL: Newly added asset NOT found.")
